...
table_file="/lustre/project/m2_jgu-funcpoll/2023_bbs_project/refseq/bbs_list.txt"

# Folder to save the output files
output_folder="/lustre/project/m2_jgu-funcpoll/2023_bbs_project/bbs_files/insect_vs_human"
...
grep -o 'NP_[^[:space:]]*' "$table_file" | while read -r np_string; do
    ...
    for blast_file in "$blast_folder"/*_human.blast; do
